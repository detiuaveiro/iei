...
**Este projeto é estritamente individual.** Selecione **um** dos seguintes projetos. Todos os projetos serão alojados no **GitHub**, utilizando o [GitHub Classroom](https://classroom.github.com/a/XSWNtxkp). Verifique [aqui](#github-classroom-access) para detalhes.
...
Este é o **projeto de recurso**, desenhado para integrar as várias competências adquiridas ao longo do semestre (Shell Scripting, Docker, Python, Data Analysis e Web Technologies).
...
1.  **Aceder ao link:** Ir [aqui](https://classroom.github.com/a/XSWNtxkp)
